...
lucas_rmse = np.sqrt(mean_squared_error(y_lucas, rf.predict(X_lucas)))
lucas_mae = mean_absolute_error(y_lucas, rf.predict(X_lucas))
lucas_r2 = r2_score(y_lucas, rf.predict(X_lucas))
