...
test_data_tensor = torch.tensor(test_df.drop(['POINT_ID','OC','sample_ID','latitude','longitude'], axis = 1).values.astype(np.float32)) 
...
for e in range(epochs):
    ...
    print('Epoch {:d} | Loss {:.4f} | RMSE {:.4f} | MAE {:.4f} | R2 {:.4f}'.format(e, loss, rmse, mae, r2))
