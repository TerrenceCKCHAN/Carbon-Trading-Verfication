...
input_paths = {
    'model_G': fr'C:\Users\admin\OneDrive\Computing\Yr5 Advanced Computing\MAC Project\Carbon-Trading-Verification\scotland_carbon\data\MODEL_G_EVAL.tif',
    'model_H': fr'C:\Users\admin\OneDrive\Computing\Yr5 Advanced Computing\MAC Project\Carbon-Trading-Verification\scotland_carbon\data\MODEL_H_EVAL.tif'
}
...
plot_single_graph(
    np.abs((soc_result[:130,:192]+agb_result[:130,:192])- (agb_truth[:130,:192] + soc_truth[:130,:192])),
    'YlOrRd' ,
    '../../report_output/novel_model_GH/carbon_maps/total_carbon_map_err.png'
    )
